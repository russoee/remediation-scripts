<#
.SYNOPSIS
    Disables solicited remote assistance to comply with STIG ID WN10-CC-000155.
...
.USAGE
    ...
    ```powershell
    .\WN10-CC-000155_remediation.ps1
    ```
#>
...
if ($Result -eq $RegValue) {
    Write-Host "Solicited Remote Assistance has been disabled successfully." -ForegroundColor Green
} else {
